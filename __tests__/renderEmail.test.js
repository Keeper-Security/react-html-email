...
import { A, PropTypes as EmailPropTypes } from '../src/index'
...
describe('renderEmail', () => {
  ...
  it('warns on usage of an unsupported property via prop-types', () => {
    const spy = jest.spyOn(console, 'error').mockImplementation()
    const style = { listStylePosition: 'inside' }
    checkPropTypes(EmailPropTypes, { style }, 'style', 'A')
    expect(spy).toHaveBeenCalled()
    expect(spy).toHaveBeenCalledWith('Warning: Failed style type: Style property `list-style-position` supplied to `A` unsupported in: outlook.')
  })
})
